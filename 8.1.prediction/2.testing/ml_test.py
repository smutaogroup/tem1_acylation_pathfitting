# This script does prediction w/ all ML models on all testing / shuffled testing sets.
# It basically generates most of the data for publication.
# NOTE that: 
...
def get_ds(basis, ds_id, which_ds):
    ...
    which_ds(str):  specify name of dataset, name should be one of the following
        ...
        group_labels
    '''
    ds_prefix = '../../7.feat.sele/2.rfecv.sele'
...
def get_feature_count(basis):
    ...
    '''
    prefix = '../../7.feat.sele/2.rfecv.sele/'
    fdir = '{0}/{1}.ml_dat/{1}.bond_labels.dat'.format(prefix, basis, )
